...
class Ethnicity
{
     ...
     *
     * @ORM\OneToMany(targetEntity="Truckee\ProjectmanaBundle\Entity\Member", mappedBy="ethnicity", cascade={"persist"})
     */
    protected $members;
     ...
     * @return Ethnicity
     */
    public function addMember(\Truckee\ProjectmanaBundle\Entity\Member $members)
    {
