...
//src\App\Services\DetailsReport.php
...
class DetailsReport
{
    ...
    {
        $households = $this->em->getRepository('App:Contact')->detailsHouseholds($criteria);
        $members = $this->em->getRepository('App:Contact')->detailsMembers($criteria);
