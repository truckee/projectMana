...
//src\App\Services\CriteriaBuilder.php
...
class CriteriaBuilder
{
    ...
    private function setContactCriteria($formSiteCriteria)
    {
        if ('' !== $formSiteCriteria['contactdesc']) {
            ...
            $contactdesc = $this->em->getRepository('App:Contactdesc')->find($id);
