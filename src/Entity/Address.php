...
class Address
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\Household", inversedBy="addresses", cascade={"persist"})
     * @ORM\JoinColumns({
     ...
     * Set addresstype.
     *
     * @param \App\Entity\AddressType $addresstype
     *
     * @return Contact
     */
