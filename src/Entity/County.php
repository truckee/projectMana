...
class County
{
     ...
     *
     * @ORM\OneToMany(targetEntity="App\Entity\Center", mappedBy="county", cascade={"persist"})
     */
    protected $centers;
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\OneToMany(targetEntity="App\Entity\Contact", mappedBy="county", cascade={"persist"})
     */
    protected $contacts;
     ...
     * Add centers.
     *
     * @param \App\Entity\Center $centers
     *
     * @return County
     */
    public function addCenter(\App\Entity\Center $centers)
    {
     ...
     * @param \App\Entity\Center $centers
     */
    public function removeCenter(\App\Entity\Center $centers)
    {
     ...
     * Add addresses.
     *
     * @param \App\Entity\Address $addresses
     *
     * @return Household
     */
